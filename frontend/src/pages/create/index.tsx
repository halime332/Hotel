...
import { createPlace } from "../../utils/servis";
  ...
  return( 
    <div className="container">
      <Formik initialValues={initialValues} onSubmit={onSubmit}>
        <Form className="max-w-2xl mx-auto grid gap-5">
          {inputs.map((item, key)=>{
           const isInput =item.type !=="checkbox";
            ...
            return(
          <div className={isInput ?"field" : "check-field" } 
          key={key}>
        ...
        <button disabled={isPending} className="my-5 bg-blue-500 py-2 px-6 text-white font-bold 
        rounded-md transition hover:bg-blue-600" type="submit">
